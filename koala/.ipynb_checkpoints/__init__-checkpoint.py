...
class Koala(DataFrame):
	...
	def lin(self, x, y):
		...
		Return:
			AttrDict {'a', 'b', 'r', 'equation', 'fig', 'graph'}
		"""
		...
		return attrdict.AttrDict({"a":a, "b":b, "r":r, "equation":f, "fig":fig, "graph":g})
	...
	def reg(self, X, Y):
		...
		Arguments:
			...
			show: [bool] , défaut=True, Si True, le graphique avec la droite de regression est affiché
		Return:
			AttrDict {'plot', 'lin', 'exp', 'pwr', 'fig', 'g1', 'g2', 'g3', 'g4'}
		"""
		...
		return attrdict.AttrDict({"fig":fig, "lin":lin, "exp":exp, "pwr":pwr, "fig":fig, "g1":g1, "g2":g2, "g3":g3, "g4":g4 })
